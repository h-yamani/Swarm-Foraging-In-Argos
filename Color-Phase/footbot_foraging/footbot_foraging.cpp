...
*/                                   
					     ...
					     tData[3] = it->second.Data[3];	   
				             tData[4] = it->second.Data[4];
		                             ...
		                             tData[9] = 2;
                                             ...
                                             if(it->second.Data[6]== 2){
                                                 m_sStateData.employers=Floor(m_sStateData.NumberOfForagers/2);}
                                             if(it->second.Data[6]== 3){
                                                 m_sStateData.employers=Floor(m_sStateData.NumberOfForagers/3);}
                                             if(it->second.Data[6]== 4){
                                                 m_sStateData.employers=Floor(m_sStateData.NumberOfForagers/4);}
                                                 tData[0] = it->second.Data[0];
						 tData[1] = it->second.Data[1];
				                 tData[2] = it->second.Data[2];
					         tData[3] = it->second.Data[3];	   
			 ...
			 break; }//end of case=1
                         case 2:{
                                    ...
                                    //m_sStateData.employers=it->second.Data[0];
                                    tData[0] = it->second.Data[0];
			            tData[1] = it->second.Data[1];
				    tData[2] = it->second.Data[2];
				    tData[3] = it->second.Data[3];	   
						     ...
						     tData[4] = it->second.Data[4];
							     ...
							     tData[4] = it->second.Data[4];
					                ...
					                m_pcLEDs->SetAllColors(CColor::MAGENTA);
                                                        ...
                                                        FindFood();
					                m_sStateData.State = SStateData::STATE_EXPLORING;
                                                        m_sStateData.EnergyState = SStateData::STATE_LEAVING_HOME;}//end of if
		   ...
		   if(m_sStateData.InNest) {
			 ...
			 if(m_sStateData.TimeSearchingForPlaceInNest > m_sStateData.MinimumSearchForPlaceInNestTime) {
			    ...
			    tData[4] = (UInt8)(y_convert/100);
                            ...
                            tData[6] = m_sStateData.food_color; //m_sStateData.Food.GetY()>=0?2:0; 
                            tData[9] = 1;
...
void CFootBotForaging::FindFood(){
   ...
   m_sStateData.distance =Floor( sqrt((delta_x*delta_x)+(delta_y *delta_y ))* 100 ); //4*4=90
   //std::cout<<"distance ="<< m_sStateData.distance<< std::endl;
}
