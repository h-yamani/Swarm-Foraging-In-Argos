...
//neural network function
   void EstimateQuantity();
   void BackPropagateError(Real output,Real target,UInt32 index);
   UInt32 Area(Real f_x ,Real f_y );
private:
   ...
   size_t robots_send ;
   std::vector<CVector2> hive_stack;
   bool hive_time;
////////////////// neural network /////////////////
